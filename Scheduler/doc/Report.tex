...
\includegraphics[width=0.8\textwidth]{./Images/Markov_20_wrong.png}

La versione precedente è stata eseguita come richiesto dall'esercizio, cioè con un time slice che è un istanza di una esponenziale invece che un valore fisso , in più ogni volta che un cliente viene processato viene ottenuta una nuova istanza del tempo di burst. Se invece eseguo il simulatore con un time slice molto più alto il ottengo questo risultato 

\includegraphics[width=0.8\textwidth]{./Images/Markov_20_modified.png}

Che mi sembra più vicino a ciò che il modello di markov sta predicendo.
