...
function(generate_gtest)
  ...
  target_link_libraries(${G_PROJECT_NAME}_unit PRIVATE GTest::gtest GTest::gtest_main ${G_ADDITIONAL_TARGET_LIBS})
  target_include_directories(${G_PROJECT_NAME}_unit PRIVATE ${G_INCLUDE_DIRS})
